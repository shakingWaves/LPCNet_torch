...
def main():
    ...
    parse.add_argument('-f', '--feature_file', type=str,
                       default='E:/Research/Synthesis/BZNSYP/ttt/009915.feature.f32', help='features file to train')
    parse.add_argument('-o', '--out_file', type=str,
                       default='E:/Research/Synthesis/BZNSYP/ttt/009915.feature.f32.s16', help='features file to train')
